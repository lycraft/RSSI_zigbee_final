...
#define SAMPLEAPP_BLIND_CLUSTERID 1
#define SAMPLEAPP_FLASH_CLUSTERID     2
#define SAMPLEAPP_ROUT_ANODE_CLUSTERID 3
#define SAMPLEAPP_ROUT_BNODE_CLUSTERID 4
#define SAMPLEAPP_ROUT_CNODE_CLUSTERID 5

  
// Send Message Timeout
#define SAMPLEAPP_SEND_PERIODIC_MSG_TIMEOUT   100     // Every 0.1 seconds
